...
public class QueenTest {
    ...
    @Test
    public void GetCandidateMoves_Black_Row8_Col4_Returns21Candidates() {
        Queen queen = new Queen(Color.BLACK);
        Position position = EasyMock.createMock(Position.class);
        ...
        List<Position> expected = List.of(
                new Position(7,4), new Position(6,4), new Position(5,4), new Position(4,4),
                new Position(3,4), new Position(2,4), new Position(1,4), new Position(8,5),
                new Position(8,6), new Position(8,7), new Position(8,8), new Position(8,3),
                new Position(8,2), new Position(8,1), new Position(7,5), new Position(6,6),
                new Position(5,7), new Position(4,8), new Position(7,3), new Position(6,2),
                new Position(5,1)
        );
    ...
    @Test
    public void GetCandidateMoves_White_Row4_Col1_Returns21Candidates() {
        Queen queen = new Queen(Color.WHITE);
        Position position = EasyMock.createMock(Position.class);
    ...
    @Test
    public void GetCandidateMoves_White_Row4_Col4_Returns27Candidates() {
        Queen queen = new Queen(Color.WHITE);
        Position position = EasyMock.createMock(Position.class);
        ...
        List<Position> expected = List.of(
                ...
                new Position(3,4), new Position(2,4), new Position(1,4), new Position(4,5),
                new Position(4,6), new Position(4,7), new Position(4,8), new Position(4,3),
                new Position(4,2), new Position(4,1), new Position(5,5), new Position(6,6),
                new Position(7,7), new Position(8,8), new Position(5,3), new Position(6,2),
                new Position(7,1), new Position(3,5), new Position(2,6), new Position(1,7),
